...
public:
    Robot_Flame_e_o() : RobotBase(2, 5, flamethrower), targetRow(-1), targetCol(-1), hasTarget(false) {
        m_name = "Flame-o";
...
extern "C" RobotBase* create_robot() { return new Robot_Flame_e_o(); }
extern "C" const char* robot_summary() { return "Scans all, moves to enemy, flames within 4 cells."; }
